                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ url('/login/auth') }}" class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Username" id="username" type="text" class="form-control" name="username" tabindex="1" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Password" id="password" type="password" class="form-control" name="password" tabindex="2" required>
                                        <div class="invalid-feedback">
